 ...
 */
public class IdcLocationManagerImpl implements LocationListener, IdcLocationManager {
    ...
    private ServiceConnection mConnection = new ServiceConnection() {
        ...
        public void onServiceConnected(ComponentName className,
            ...
            mLocationTrackerServiceBinder.registerLocationListener(IdcLocationManagerImpl.this);
        }
    ...
    public IdcLocationManagerImpl(Context context, UiThreadPoster uiThreadPoster, Logger logger) {
        mContext = context;
